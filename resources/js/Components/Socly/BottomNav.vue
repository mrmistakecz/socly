...
const navItems = [
  { id: 'home', icon: Home, label: 'Domu' },
  { id: 'discover', icon: Compass, label: 'Objevit' },
  { id: 'add', icon: Plus, label: '' },
  { id: 'messages', icon: MessageCircle, label: 'Zpravy', badge: 3 },
...
<template>
  <nav class="fixed bottom-0 left-0 right-0 z-50 pb-safe lg:hidden">
    <div class="mx-4 mb-4">
      <div class="glass-heavy rounded-2xl border border-border/30">
          ...
          <template v-for="item in navItems" :key="item.id">
            ...
            >
              <div class="relative">
                ...
                <span 
                  v-if="item.badge" 
                  class="absolute -top-1.5 -right-2 min-w-[18px] h-[18px] px-1 rounded-full bg-primary flex items-center justify-center"
                >
